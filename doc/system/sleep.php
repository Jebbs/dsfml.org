<!DOCTYPE HTML>
  <html>
    <head>
      ...
      <title>DSFML - dsfml.system.sleep</title>
    </head>
    <body>
      <div class="main">
        ...
        <div class="inner" class="content">
          <article class="module">
            <h1 class="module_name">dsfml.system.sleep</h1>
...
<section class="section ddoc_module_members_section">
  ...
  <section class="section">
    <div class="declaration">
      <div class="dlang">
        <code class="prettyprint"><a class="decl_anchor" href="#sleep" id="sleep">void sleep(Time duration);
</a></code>
      </div>
    </div>
  </section>
...
<div class="ddoc_params">
  ...
  <code class="prettyprint">Time duration</code>
</td>
<td>
  <div class="ddoc_param_desc">
    <p class="param_desc">
      The length of time to sleep for
    </p>
  </div>
</td>
</tr>
