<!DOCTYPE HTML>
  <html>
    <head>
      ...
      <title>DSFML - dsfml.window.sensor</title>
    </head>
    <body>
      <div class="main">
        ...
        <div class="inner" class="content">
          <article class="module">
            <h1 class="module_name">dsfml.window.sensor</h1>
            <section id="module_content"><section class="section ddoc_sections">
  <div class="ddoc_summary">
  <p class="para">
    <u>Sensor</u> provides an interface to the state of the various sensors that a
...
<br><br>
 ...
 of a sensor before trying to read it, with the <code class="prettyprint">Sensor.isAvailable</code> function.
<br><br>
...
<br><br>
 ...
 disabled by default. You must call <code class="prettyprint">Sensor.setEnabled</code> for each sensor in
...
<section class="code_listing">
  <div class="code_sample">
    <pre><code class="prettyprint">if (Sensor.isAvailable(Sensor.Type.Gravity))
{
...
<section class="section ddoc_module_members_section">
  ...
  <section class="section">
    <div class="declaration">
      <div class="dlang">
        <code class="prettyprint"><a class="decl_anchor" href="#Sensor" id="Sensor">abstract class Sensor;
</a></code>
      </div>
    </div>
  </section>
...
<ul class="ddoc_members">
  ...
  <section class="section">
    <div class="declaration">
      <div class="dlang">
        <code class="prettyprint"><a class="decl_anchor" href="#Sensor.Type" id="Sensor.Type">enum Type: int;
</a></code>
      </div>
    </div>
  </section>
...
<ul class="ddoc_enum_members">
  ...
  <section class="section">
    <div class="declaration">
      <div class="dlang">
        <code class="prettyprint"><a class="decl_anchor" href="#Sensor.Type.Accelerometer" id="Sensor.Type.Accelerometer">Accelerometer</a></code>
      </div>
    </div>
  </section>
</div>
<div class="ddoc_decl_dd">
  ...
  <section class="section">
    <div class="declaration">
      <div class="dlang">
        <code class="prettyprint"><a class="decl_anchor" href="#Sensor.Type.Gyroscope" id="Sensor.Type.Gyroscope">Gyroscope</a></code>
      </div>
    </div>
  </section>
</div>
<div class="ddoc_decl_dd">
  ...
  <section class="section">
    <div class="declaration">
      <div class="dlang">
        <code class="prettyprint"><a class="decl_anchor" href="#Sensor.Type.Magnetometer" id="Sensor.Type.Magnetometer">Magnetometer</a></code>
      </div>
    </div>
  </section>
</div>
<div class="ddoc_decl_dd">
  ...
  <section class="section">
    <div class="declaration">
      <div class="dlang">
        <code class="prettyprint"><a class="decl_anchor" href="#Sensor.Type.Gravity" id="Sensor.Type.Gravity">Gravity</a></code>
      </div>
    </div>
  </section>
</div>
<div class="ddoc_decl_dd">
 ...
 device acceleration (m/s²)
  ...
  <section class="section">
    <div class="declaration">
      <div class="dlang">
        <code class="prettyprint"><a class="decl_anchor" href="#Sensor.Type.UserAcceleration" id="Sensor.Type.UserAcceleration">UserAcceleration</a></code>
      </div>
    </div>
  </section>
</div>
<div class="ddoc_decl_dd">
 ...
 independent of the gravity (m/s²)
  ...
  <section class="section">
    <div class="declaration">
      <div class="dlang">
        <code class="prettyprint"><a class="decl_anchor" href="#Sensor.Type.Orientation" id="Sensor.Type.Orientation">Orientation</a></code>
      </div>
    </div>
  </section>
</div>
<div class="ddoc_decl_dd">
  ...
  <section class="section">
    <div class="declaration">
      <div class="dlang">
        <code class="prettyprint"><a class="decl_anchor" href="#Sensor.Type.Count" id="Sensor.Type.Count">Count</a></code>
      </div>
    </div>
  </section>
</div>
<div class="ddoc_decl_dd">
  ...
  <section class="section">
    <div class="declaration">
      <div class="dlang">
        <code class="prettyprint"><a class="decl_anchor" href="#Sensor.isAvailable" id="Sensor.isAvailable">static bool isAvailable(Type sensor);
</a></code>
      </div>
    </div>
  </section>
...
<div class="ddoc_params">
  ...
  <code class="prettyprint">Type sensor</code>
</td>
<td>
...
<div class="ddoc_returns">
  <h4>Returns:</h4>
  <p class="para">
    <code class="prettyprint">true</code> if the sensor is available, <code class="prettyprint">false</code> otherwise.
  </p>
</div>
  ...
  <section class="section">
    <div class="declaration">
      <div class="dlang">
        <code class="prettyprint"><a class="decl_anchor" href="#Sensor.setEnabled" id="Sensor.setEnabled">static void setEnabled(Type sensor, bool enabled);
</a></code>
      </div>
    </div>
  </section>
...
<td>
  ...
  <section class="section">
    <div class="declaration">
      <div class="dlang">
        <code class="prettyprint"><a class="decl_anchor" href="#Sensor.getValue" id="Sensor.getValue">static Vector3f getValue(Type sensor);
</a></code>
      </div>
    </div>
  </section>
