...
<body>
    <div class="main">
        ...
        <div class="inner" class="content">
            ...
            <pre><code class="prettyprint">module main;
...
void main(string[] args)
{
    ...
    while (window.isOpen())
    {
        ...
        window.display();
            ...
            <pre style="white-space: pre-wrap;">dmd app.d -m32mscoff -IDSFML\src\ -L/LIBPATH:DSFMLC\lib\ -L/LIBPATH:DSFML\lib\ dsfml-graphics.lib dsfml-window.lib dsfml-system.lib sfml-graphics.lib sfml-window.lib sfml-system.lib</pre>
            <h3>Windows - 64 bit</h3>
            <pre style="white-space: pre-wrap;">dmd app.d -m64 -IDSFML\src\ -L/LIBPATH:DSFMLC\lib\ -L/LIBPATH:DSFML\lib\ dsfml-graphics.lib dsfml-window.lib dsfml-system.lib sfml-graphics.lib sfml-window.lib sfml-system.lib</pre>
            <h3>Linux/macOS</h3>
            <pre style="white-space: pre-wrap;">dmd app.d -IDSFML\src\ -L-LDSFMLC\lib\ -L-LDSFML\lib\ -L-ldsfml-graphics -L-ldsfml-window -L-ldsfml-system -L-lsfml-graphics -L-lsfml-window -L-lsfml-system</pre>
            <h2 id="compiling-dub">Compiling - DUB</h2>
            <p class="para">
            Using DUB to build your simplifies a lot of things. All you need to
            ...
            add "/LIBPATH:DSFMLC\\lib\\" to your lflags setting, while on Linux
            or macOS you'll probably add "-LDSFMLC/lib".
            </p>
